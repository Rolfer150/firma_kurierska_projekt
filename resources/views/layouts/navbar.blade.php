        ...
        <nav class="navbar navbar-expand-lg bg-white navbar-light p-0">
            ...
            <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                ...
                <div class="navbar-nav mr-auto py-0">
                    ...
                    @else
                            @can('isAdmin')
                                <a href="{{ route('adminmain') }}" class="nav-item nav-link active">Strona główna - administrator</a>
                                <a href="{{ route('Przesylkas.indexklient') }}" class="nav-item nav-link">Lista pracowników</a>
                                <a href="{{ route('paczkomat.create') }}" class="nav-item nav-link">Dodaj paczkomat</a>
                                <a href="/#" class="nav-item nav-link">Powiadomienia</a>
                            @endcan
                        @can('isUser')
