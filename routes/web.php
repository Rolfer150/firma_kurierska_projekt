...
Route::get('kuriers/przesylkas/edit/{przesylka}',[PrzesylkaController::class,'editkurier'])->name('Przesylkas.editkurier')->middleware('can:isDeliveryman');Route::post('kuriers/przesylkas/{przesylka}', [PrzesylkaController::class, 'updatekurier'])->name('Przesylkas.updatekurier')->middleware('can:isDeliveryman');
